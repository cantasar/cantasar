...
| Project | Description |
|---------|-------------|
| [Inception](https://github.com/cantasar/Inception) | **Goal:** Service virtualization system using containerization<br>- **Docker** and **Docker Compose** orchestration<br>- **NGINX** with TLS/SSL for reverse proxy<br>- **WordPress** with **PHP-FPM** for web service<br>- **MariaDB** for database<br>- Additional services: **Redis** cache, **vsftpd** FTP server, **Adminer**, static website |
| [IRC Server](https://github.com/cantasar/IRC) | **Goal:** TCP/IP based real-time communication protocol<br>- **Socket programming** with client-server architecture<br>- **Multiplexing** with select() for connection handling<br>- **Protocol implementation** for IRC commands<br>- **Buffer management** for message processing |
| [EduManage](https://github.com/cantasar/EduManage) | **Goal:** Educational institution management system<br>- **ASP.NET Core 8.0** with RESTful API design<br>- **Entity Framework Core** with Code-First approach<br>- **CRUD operations** for relational data<br>- **Dependency Injection** for service management<br>- **Repository pattern** implementation |
| [Cub3D](https://github.com/cantasar/cub3D) | **Goal:** First-person 3D rendering engine<br>- **Raycasting** algorithm implementation<br>- **DDA (Digital Differential Analysis)** for ray calculations<br>- **Texture mapping** for walls and sprites<br>- **Collision detection** using hit-boxes |
| [CPP Modules](https://github.com/cantasar/cpp-modules) | **Goal:** Object-oriented programming implementation<br>- **Inheritance** and **Polymorphism** demonstrations<br>- **Templates** for generic programming<br>- **Operator overloading** implementation<br>- **Exception handling** mechanisms |
...
## 📫 Connect With Me
  ...
  <a href="https://linkedin.com/in/can-tasar">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"/>
  </a>
  <a href="https://github.com/cantasar">
